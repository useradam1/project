...
from typing import Union, Literal, Optional, overload, Tuple
from numpy import ndarray, float32, dtype, ndim
...
class vec2_ptr_static(vec2):
	...
	def LinkMemory(self, buffer: ndarray[tuple[int], dtype[float32]], offset: int ) -> None: ...
	...
	def SetValues(self, x: float, y: float) -> vec2_ptr_static: ...
	def SetVector(self, value: vec2) -> vec2_ptr_static: ...
	...
	def NormalizeFrom(self, value: vec2) -> vec2: ...
	@staticmethod
...
class vec2:
	...
	def SetValues(self, x: float, y: float) -> vec2: ...
	def SetVector(self, value: vec2) -> vec2: ...
...
class mat2:
	...
	def SetMatrix(self, value: mat2) -> mat2: ...
	...
	def InverseFrom(self, value: mat2) -> mat2: ...
	@staticmethod
	def GetInverse(value: mat2) -> mat2: ...

	def Transpose(self) -> mat2: ...
	def TransposeFrom(self, value: mat2) -> mat2: ...
	@staticmethod
...
class vec3:
	...
	def SetValues(self, x: float, y: float, z: float) -> vec3: ...
	def SetVector(self, value: vec3) -> vec3: ...
	...
	def NormalizeFrom(self, value: vec3) -> vec3: ...
	@staticmethod
	def GetNormalized(value: vec3) -> vec3: ...
	@staticmethod
	def GetDotProduct(valueA: vec3, valueB: vec3) -> float: ...
	def CrossProduct(self, value: vec3) -> vec3: ...
	def CrossProductFrom(self, valueA: vec3, valueB: vec3) -> vec3: ...
	@staticmethod
...
class mat3:
	...
	def SetValues(self, 
		...
		m31: float, m32: float, m33: float) -> mat3: ...
	def SetMatrix(self, value: mat3) -> mat3: ...
	...
	def TransposeFrom(self, value: mat3) -> mat3: ...
	@staticmethod
...
class Rotation(mat3):
	...
	def SetValues(self, 
		m11: float, m12: float, m13: float, 
		m21: float, m22: float, m23: float, 
		m31: float, m32: float, m33: float) -> Rotation: ...
	def SetMatrix(self, value: mat3) -> Rotation: ...
	...
	def TransposeFrom(self, value: Rotation) -> Rotation: ...
	@staticmethod
...
class vec4:
	...
	def SetValues(self, x: float, y: float, z: float, w: float) -> vec4: ...
	def SetVector(self, value: vec4) -> vec4: ...
	...
	def NormalizeFrom(self, value: vec4) -> vec4: ...
	@staticmethod
...
class mat4:
	...
	def SetMatrix(self, value: mat4) -> mat4: ...
	...
	def TransposeFrom(self, value: mat4) -> mat4: ...
	@staticmethod
...
class mat4_ptr_static(mat4):

	def LinkMatrix(self, value: mat4) -> None: ...
...
class Transform:
	def LinkMemoryLocalSRT(self, buffer: ndarray[tuple[int], dtype[float32]], offset: int ) -> None: ...

	def UnlinkMemoryLocalSRT(self) -> None: ...

	def LinkMemoryGlobalSRT(self, buffer: ndarray[tuple[int], dtype[float32]], offset: int ) -> None: ...

	def UnlinkMemoryGlobalSRT(self) -> None: ...


	def LinkMemoryLocalTRS(self, buffer: ndarray[tuple[int], dtype[float32]], offset: int ) -> None: ...

	def UnlinkMemoryLocalTRS(self) -> None: ...

	def LinkMemoryGlobalTRS(self, buffer: ndarray[tuple[int], dtype[float32]], offset: int ) -> None: ...
...
class Ray:
	def __init__(self, ro: vec3, rd: vec3) -> None: ...

	@property
	def ro(self) -> vec3: ...
	@ro.setter
	def ro(self, value: vec3) -> None: ...

	@property
	def rd(self) -> vec3: ...
	@rd.setter
	def rd(self, value: vec3) -> None: ...


class IntersectResult:
	def __init__(self, ro: vec3, rd: vec3, hit_point: vec3, hit_normal: vec3, nearest_hit_distance: float) -> None: ...

	def SetValue(self, intersect_result: IntersectResult) -> None: ...
	...
	@hit_point.setter
	def hit_point(self, value: vec3) -> None: ...

	@property
	def hit_normal(self) -> vec3: ...
	@hit_normal.setter
	def hit_normal(self, value: vec3) -> None: ...

	@property
	def nearest_hit_distance(self) -> float: ...
	@nearest_hit_distance.setter
	def nearest_hit_distance(self, value: float) -> None: ...
	


def sphIntersect(ray: Ray, sphere: mat4, intersect_result: IntersectResult) -> None: ...