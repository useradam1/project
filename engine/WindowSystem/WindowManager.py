...
class WindowManager:
	...
	__QUEUE_TO_APPEND: Set[WindowInterface] = set()
	__QUEUE_TO_REMOVE: Set[WindowInterface] = set()

	__CAN_UPDATE_WINDOWS: bool = False
	__WINDOWS: List[WindowInterface] = []
	...
	@classmethod
	def AppendWindow(cls, window: WindowInterface) -> bool:
	...
	@classmethod
	def RemoveWindow(cls, window: WindowInterface) -> None:
